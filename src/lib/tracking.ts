...
export function trackEvent(
  ...
  if (eventName === "page_view") {
    firedTags.push("GA4 Config Tag (G-VWJ28W6KCV)", "Meta Pixel Base (1535033778024253)", "Clarity Base (m3v1h4n8x2)", "LinkedIn Insight Tag (5829104)");
